Got it, Masub!
Here is **the complete step-by-step guidance in one clean, ready-to-use Markdown (.md) file**.
You can **copy–paste this entire message into any `.md` file** and use it for teaching your students.
